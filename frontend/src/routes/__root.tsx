...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Zero-auth, production-ready trip expense manager. Track shared bills and simplify who owes whom." },
      { property: "og:title", content: "HanGan (หารกัน)" },
      { property: "og:description", content: "Zero-auth, production-ready trip expense manager." },
